                ...
                >
                  ...
                  <Chip
                    ...
                    sx={{
                      ...
                      fontWeight: 500,
                      borderRadius: '20px',
                      backgroundColor: isSelected ? 'neutral.800' : 'background.surface',
                      borderColor: isSelected ? 'neutral.800' : 'neutral.200',
                      color: isSelected ? 'common.white' : 'text.primary',
                      transition: 'all 0.2s ease',
                      '&:hover': {
                        backgroundColor: isSelected ? 'neutral.700' : 'neutral.50',
                        borderColor: isSelected ? 'neutral.700' : 'neutral.300',
                      },
                    }}
                  >
                    {prompt.text}
